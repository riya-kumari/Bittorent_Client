...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    // ----------------------------------------------------------
    // Create client and start the download
    // ----------------------------------------------------------
    Client torrent_client(peers_list, info_hash_str, tracker.peer_id);
    torrent_client.download_torrent();
